...
public class Msm_6{
  ...
  @SubAnnotation(type = "array",startPos = 0, len = 10, mark="",className="com.longge.gather.gnss.common.protocal.rtcm32.msm.satdata.MsmSatData_46")
  private MsmSatData_46[] msmSatDatas;
  
  @SubAnnotation(type = "array",startPos = 0, len = 10, mark="",className="com.longge.gather.gnss.common.protocal.rtcm32.msm.sigdata.MsmSigData_6")
