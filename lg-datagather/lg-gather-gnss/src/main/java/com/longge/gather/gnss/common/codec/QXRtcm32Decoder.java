 ...
 * @version V1.0
 */
public class QXRtcm32Decoder extends ByteToMessageDecoder {
	
	//日志
	private static final Logger logger = LoggerFactory.getLogger(QXRtcm32Decoder.class);
