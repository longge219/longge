package com.longge.gather.gnss.server.protocal.rtcm32.arp;
...
import lombok.Data;
/**
 * @description 固定天线参考点电文1006
 * @author jianglong
 * @create 2018-04-02
 **/
@Data
public class Arp_1006 implements ProtocolHead {
	 ...
	 * */
	@SubAnnotation(type = "int",startPos = 152, len = 16, mark="",className="")
	private int antennaHigh;
