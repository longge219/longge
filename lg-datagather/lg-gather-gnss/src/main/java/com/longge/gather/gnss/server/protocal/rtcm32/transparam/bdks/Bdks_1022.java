package com.longge.gather.gnss.server.protocal.rtcm32.transparam.bdks;
 ...
 **/
@Data
public class Bdks_1022 implements ProtocolHead {
	...
	@SubAnnotation(type = "int",startPos = 17, len = 35, mark="",className="")
	private long xP ;//XP
	...
	private byte flatIndex ;//赫尔默特（Helmert）/莫洛金斯基（Molodenski）平面精度指标
