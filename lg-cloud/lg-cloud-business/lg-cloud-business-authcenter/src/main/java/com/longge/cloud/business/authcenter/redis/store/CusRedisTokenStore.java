package com.longge.cloud.business.authcenter.redis.store;
...
/**
 * @author jianglong
 * @decription 重写tokenStore .因为最新版中RedisTokenStore的set已经被弃用了，所以我就只能自定义一个，代码和RedisTokenStore一样，
 * 只是把所有conn.set(…)都换成conn..stringCommands().set(…)
 * @date 2019-01-14
 */
@Component
public class CusRedisTokenStore implements TokenStore {
    ...
    public CusRedisTokenStore(RedisConnectionFactory connectionFactory) {
